...
public class MovieSearchLoader extends AsyncTaskLoader<ArrayList<MovieItems>> {
    ...
    public ArrayList<MovieItems> loadInBackground() {
        ...
        String url = "https://api.themoviedb.org/3/search/movie?api_key="+ BuildConfig.MYAPIKEY +"&language=en-US&query=";
        Log.d("nilai title url", ""+mTitle);

        client.get(url + mTitle, new AsyncHttpResponseHandler() {
