...
public class MovieNowPlayingLoader extends AsyncTaskLoader<ArrayList<MovieItems>> {
    ...
    public ArrayList<MovieItems> loadInBackground() {
        ...
        String url = "https://api.themoviedb.org/3/movie/now_playing?api_key="+ BuildConfig.MYAPIKEY +"&language=en-US";
